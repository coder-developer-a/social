    ...
    return (
        <div className='header d-flex justify-content-between align-items-center row set-position py-2'>
            <div className='col-12 col-sm-6 d-flex align-items-center justify-content-center justify-content-sm-start mb-2'>
                <Link to='/' className='brand text-nowrap'><i className="bi bi-camera pe-1"></i>Social</Link>
                <div className="dropdown d-none d-sm-block">
                    <button className="btn category-top pb-0 dropdown-toggle pe-0 m-0" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        Category
                    </button>
            ...
            <div className='d-sm-none col-12 col-sm-6'>
            ...
            <div className='col-12 col-sm-5'>
                <form className='d-flex align-items-center justify-content-center justify-content-sm-end'>
                    <div>
                        <Link to='/signin'><button className='btn category-top d-none d-sm-inline-block col-4 text-nowrap'>Sign in</button></Link>
                        <input type='text' className='search-inp col-10 col-sm-7' placeholder='Search ...' aria-label='Dollar amount (with dot and two decimal places)' />
                        <span className='search-span d-inline-block col-2 col-sm-1 text-end'><i className='bi bi-search category-top'></i></span>
                    </div>
                </form>
            </div>
        </div>
